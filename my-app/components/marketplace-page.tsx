...
// Company-focused marketplace items
const companyTools = [
  {
    id: 1,
    name: "CandidateFlow Pro",
    description: "Advanced candidate management with AI-powered screening for recruitment teams",
    category: "tool",
    rating: 4.8,
    downloads: 1250,
    price: "Free",
    tags: ["AI", "Screening", "Professional"],
    author: "HireTech",
    featured: true,
  },
  {
    id: 2,
    name: "RecruitmentHub Enterprise",
    description: "Enterprise-grade recruitment platform with advanced analytics",
    category: "tool",
    rating: 4.6,
    downloads: 890,
    price: "$99.99",
  ...
  {
    id: 3,
    name: "SecureHire Enterprise",
    description: "Enterprise-grade security and compliance tools for large recruitment operations",
    category: "tool",
    rating: 4.9,
    downloads: 2100,
    price: "$49.99",
...
const companySolutions = [
  {
    ...
    description: "Intelligent resume analysis and candidate matching for specific job requirements",
    category: "solution",
    rating: 4.7,
    downloads: 3200,
    price: "Free",
  ...
  },
  {
    ...
    description: "Automated interview scheduling with calendar integration and candidate notifications",
    category: "solution",
    rating: 4.5,
    downloads: 1800,
    price: "$29.99",
    tags: ["Scheduling", "Calendar", "Automation"],
    author: "ScheduleBoost",
    featured: false,
  },
  {
    id: 6,
    name: "Hiring Analytics Bot",
    description: "Automated tracking and analytics for your recruitment pipeline and performance",
    category: "solution",
    rating: 4.8,
    downloads: 2750,
    price: "$39.99",
    tags: ["Analytics", "Tracking", "Automation"],
    author: "DataWork",
    featured: true,
  },
]

const allItems = [...companyTools, ...companySolutions]
      ...
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8 p-3 sm:p-6">
        ...
        <div className="text-center space-y-3 sm:space-y-4 py-4 sm:py-8">
          ...
          <p className="text-slate-600 text-sm sm:text-lg max-w-2xl mx-auto px-4">
            Search for recruitment tools and custom solutions here to supercharge your hiring workflow
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search for tools and solutions here..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="pl-12 pr-4 py-4 text-lg bg-white/80 backdrop-blur-sm border border-slate-200 focus:border-purple-300 focus:ring-2 focus:ring-purple-200 rounded-xl shadow-lg w-full focus:outline-none"
            />
            <Button
              size="sm"
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          ...
          <Card className="overflow-hidden bg-gradient-to-br from-pink-500 to-pink-600 text-white border-0 shadow-xl">
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-pink-100 text-xs sm:text-sm font-medium">Tools</p>
                  <p className="text-xl sm:text-3xl font-bold">{companyTools.length}</p>
                  <Badge variant="secondary" className="mt-1 sm:mt-2 bg-white/20 text-white border-white/30 text-xs">
                    Active
                  </Badge>
                </div>
          ...
          <Card className="overflow-hidden bg-gradient-to-br from-indigo-500 to-indigo-600 text-white border-0 shadow-xl">
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-indigo-100 text-xs sm:text-sm font-medium">Solutions</p>
                  <p className="text-xl sm:text-3xl font-bold">{companySolutions.length}</p>
                  <Badge variant="secondary" className="mt-1 sm:mt-2 bg-white/20 text-white border-white/30 text-xs">
                    Smart
                  </Badge>
                </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-3 max-w-md mx-auto bg-white/80 backdrop-blur-sm">
            ...
            <TabsTrigger value="tool" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white">
              Tools
            </TabsTrigger>
            <TabsTrigger value="solution" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white">
              Solutions
            </TabsTrigger>
          </TabsList>
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-800 mb-4 flex items-center gap-2">
                ...
                {searchQuery
                  ...
                  : `All ${activeTab === "all" ? "Items" : activeTab === "tool" ? "Tools" : "Solutions"}`}
              </h2>
